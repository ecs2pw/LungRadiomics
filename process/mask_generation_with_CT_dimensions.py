...
basic_mask_dicts = [
        {'NameStrings': ['itv'], 'InvalidNStrings' : ['random'], 'GV': False, 'Stationary': False, 'CardiacOutput': 1.},
        {'NameStrings': ['ptv'], 'InvalidNStrings' : ['random'], 'GV': False, 'Stationary': False, 'CardiacOutput': 1.},
        {'NameStrings': ['random_itv'], 'GV': False, 'Stationary': False, 'CardiacOutput': 1.},
        {'NameStrings': ['random_ptv'], 'GV': False, 'Stationary': False, 'CardiacOutput': 1.}
]
